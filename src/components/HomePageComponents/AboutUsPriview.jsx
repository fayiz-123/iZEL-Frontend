  ...
  return (
    <section className="py-12 px-6 md:px-16 bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        {/* Right: Text */}
        <div className="text-center md:text-left max-w-full md:max-w-[330px] mx-auto md:mx-0 px-2 sm:px-4">
          ...
          <p className="text-gray-700 text-sm sm:text-base leading-relaxed mb-4">
            ...
            handcrafted ethnic wear is designed for the woman who embraces
            culture with confidence. From timeless bridal ensembles to elegant
            everyday couture, we blend heritage craftsmanship with contemporary
            finesse to create pieces that speak to the soul.
          </p>
          <div className="mt-4">
            <button
              className="bg-red-500 hover:bg-red-600 text-white text-sm sm:text-base px-5 py-2 rounded-lg shadow-md"
